...
export default function DashboardPage() {
  ...
  } = useSWR("clients-overview", clientsService.getOverview)

  const {
    data: topBuyers,
    isLoading: loadingBuyers,
  } = useSWR("clients-top-buyers", clientsService.getTopBuyers)

  const {
    data: bestProducts,
    isLoading: loadingProducts,
  } = useSWR("products-best-selling", productsService.getBestSelling)
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        {loadingOverview ? (
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Por status de pagamento</p>
            <div className="mt-6 h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border text-left">
                    ...
                    <th className="pb-3 font-medium text-muted-foreground">Qtd. Vendida</th>
                    <th className="pb-3 font-medium text-muted-foreground">Receita</th>
                    <th className="pb-3 font-medium text-muted-foreground">Compradores</th>
                  </tr>
                </thead>
                <tbody>
